# Gemini - Ler O Acervo E Extrair O Melhor De Cada Forma De Ensinar Xadrez
...
> Identifique-se: comece sua resposta com o titulo `# Analise do Acervo - GEMINI` e salve/entregue o
> resultado como `analise-acervo-GEMINI.md`. Prefixe cada secao com a sua autoria quando fizer sentido.
> O dono vai rodar este MESMO prompt em outra IA (DeepSeek) em paralelo e depois cruzar as duas analises,
...
Portugues, direto, tabelas em Markdown quando a entrega pedir. Titulo `# Analise do Acervo - GEMINI`.
