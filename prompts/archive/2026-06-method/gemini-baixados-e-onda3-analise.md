# Gemini - Analise Dos PDFs Baixados + ONDA 3
...
> `# Analise dos PDFs Baixados + ONDA 3 - GEMINI` e salve/entregue o resultado como
> `analise-pdfs-baixados-onda3-GEMINI.md`. O dono vai rodar um prompt espelhado no DeepSeek e depois
...
## Enfase Especifica Para Gemini

Seja especialmente forte em:

- padroes pedagogicos recorrentes;
- sequenciamento didatico;
- qualidade de explicacao para adulto iniciante/intermediario;
- sintese de tradicoes diferentes sem copiar conteudo;
- lacunas conceituais que ainda travam o Metodo Professor Lemos;
- como transformar ideias em blocos claros do Professor Lemos.
...
- Nao tente prever o que DeepSeek dira.
