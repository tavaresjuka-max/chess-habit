# Gemini - ONDA 2: Ler O Novo Acervo E Extrair O Melhor De Cada Forma De Ensinar Xadrez

Voce e o **Gemini** atuando como pesquisador pedagogico senior do projeto `lichess-tutor`, uma
...
> Identifique-se: comece sua resposta com o titulo `# Analise do Acervo ONDA 2 - GEMINI` e
> salve/entregue o resultado como `analise-acervo-ONDA2-GEMINI.md`. O dono vai rodar este MESMO prompt
> em outra IA (DeepSeek) em paralelo e depois cruzar as duas analises, entao mantenha o esquema deste
...
de iniciante ("Chess for Beginners" repetidos) - marque a redundancia com clareza. Para o volume grande
de redundantes, use Fichas Coletivas agrupando-os.
...
Portugues, direto, tabelas em Markdown. Titulo `# Analise do Acervo ONDA 2 - GEMINI`. Ordem: fichas
