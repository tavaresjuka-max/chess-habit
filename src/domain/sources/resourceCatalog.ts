...
export const lichessVideoLessons = [
  resource({
    ...
    description: 'Aula direta de princípios de abertura: centro, desenvolvimento e segurança do rei.',
  ...
  resource({
    ...
    label: 'Lichess Video (em inglês): peças penduradas',
    description: 'Aula direta para reconhecer peças sem defesa antes de escolher lance candidato.',
  ...
  resource({
    ...
    description: 'Aula direta para revisar o padrão de dois alvos antes de voltar aos puzzles.',
  ...
  resource({
    ...
    kind: 'video-lesson',
    title: 'Pin',
    label: 'Lichess Video (em inglês): cravadas',
    description: 'Aula direta para reconhecer alinhamento, peça presa e alvo atrás dela.',
  ...
  resource({
    ...
    kind: 'video-lesson',
    title: 'Skewer',
    label: 'Lichess Video (em inglês): espetos',
  ...
  resource({
    ...
    label: 'Lichess Video (em inglês): ataque descoberto',
    description: 'Aula direta para enxergar a linha que abre quando uma peça se move.',
  ...
  resource({
    ...
    kind: 'video-lesson',
    title: 'Back Rank',
    label: 'Lichess Video (em inglês): mate na última fileira',
    description: 'Aula direta para revisar o rei preso e a pressão na última fileira.',
  ...
  resource({
    ...
    label: 'Lichess Video (em inglês): padrões de mate',
    description: 'Aula direta para revisar padrões de mate antes de treinar mate curto.',
  ...
  resource({
    ...
    kind: 'video-lesson',
    title: 'Pawn Endgames',
    label: 'Lichess Video (em inglês): finais de peões',
    description: 'Aula direta para revisar planos de finais de peões antes de Practice ou puzzles.',
  ...
  resource({
    ...
    kind: 'video-lesson',
    title: 'Calculation',
    label: 'Lichess Video (em inglês): cálculo',
    description: 'Aula direta para organizar cálculo e reduzir decisões por impulso.',
  ...
  resource({
    ...
    label: 'Lichess Video (em inglês): evitar blunders',
    description: 'Aula direta para reforçar checagem curta antes de lances críticos.',
  ...
  resource({
    ...
    label: 'Lichess Video (em inglês): converter vantagem material',
    description: 'Aula direta para transformar vantagem em plano prático sem depender de engine.',
...
export const lichessCommunityStudies = [
  resource({
    ...
    description: 'Estudo comunitário progressivo para reforçar finais básicos depois dos recursos oficiais.',
  ...
  resource({
    ...
    label: 'Lichess Study: finais intermediários essenciais',
    description: 'Estudo comunitário para aprofundar finais depois de Practice e puzzle themes.',
  ...
  resource({
    ...
    description: 'Estudo comunitário de reforço para finais de torre depois do Practice oficial.',
  ...
  resource({
    ...
    label: 'Lichess Study: tática iniciante jomega',
    description: 'Estudo comunitário de reforço para táticas básicas; manter abaixo de Practice e puzzles.',
  ...
  resource({
    ...
    label: 'Lichess Study: táticas simples I jomega',
    description: 'Estudo comunitário de reforço para repetir táticas básicas fora do formato de puzzle.',
  ...
  resource({
    ...
    label: 'Lichess Study: táticas simples II jomega',
    description: 'Estudo comunitário de reforço para consolidar padrões táticos básicos.',
  ...
  resource({
    ...
    label: 'Lichess Study: táticas internalizadas jomega',
    description: 'Estudo comunitário de reforço para táticas mais longas e transferência de padrões.',
...
export const rejectedLichessResources = [
  resource({
    ...
    label: 'Rejeitado: estudo comunitário de finais de peões',
    description: 'Rejeitado por risco de adaptação de livro protegido; nunca entra no catálogo ativo.',
  ...
  resource({
    ...
    title: 'Pawn Endgames!',
    label: 'Rejeitado: estudo comunitário de finais de peões',
    description: 'Rejeitado por baixa qualidade pedagógica e tom desalinhado; nunca entra no catálogo ativo.',
  ...
  resource({
    ...
    label: 'Rejeitado: estudo comunitário de mate em 2',
    description: 'Candidato fraco para catálogo ativo; manter fora até revisão humana específica.',
